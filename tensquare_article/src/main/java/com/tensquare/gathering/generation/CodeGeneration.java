...
public class CodeGeneration {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\idea-workspace\\tensquare\\tensquare_parent\\tensquare_article\\src\\main\\java");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/tensquare_article");
...
//        strategy.setInclude(new String[] {"tb_article","tb_channel","tb_column"}); // 需要生成的表
        ...
        pc.setParent("com.tensquare.article");
