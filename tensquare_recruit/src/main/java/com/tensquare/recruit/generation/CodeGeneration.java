package com.tensquare.recruit.generation;
...
public class CodeGeneration {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\idea-workspace\\tensquare\\tensquare_parent\\tensquare_recruit\\src\\main\\java");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/tensquare_recruit");
...
//        strategy.setInclude(new String[] {"tb_recruit","tb_enterprise"}); // 需要生成的表
        ...
        pc.setParent("com.tensquare.recruit");
