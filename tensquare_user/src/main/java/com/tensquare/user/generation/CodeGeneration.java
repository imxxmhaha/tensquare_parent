package com.tensquare.user.generation;
...
public class CodeGeneration {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\idea-workspace\\tensquare\\tensquare_parent\\tensquare_user\\src\\main\\java");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/tensquare_user");
...
//        strategy.setInclude(new String[] {"tb_admin","tb_follow","tb_user"}); // 需要生成的表
        ...
        pc.setParent("com.tensquare.user");
